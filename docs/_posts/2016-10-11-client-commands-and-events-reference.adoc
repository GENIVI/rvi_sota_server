...
The Websocket gateway supports subscribing to every event in the client. This gateway is currently used for updating the ATS Garage web interface for example.
