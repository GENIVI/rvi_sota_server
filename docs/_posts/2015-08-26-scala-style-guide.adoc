...
2.  https://github.com/databricks/scala-style-guide[Databricks Scala
Guide]
...
1.  link:#syntactic[Syntactic Style]
* link:#identation[Identation]
* link:#naming[Naming Convention]
* link:#declarations[Declarations]
* link:#imports[Imports]
* link:#control_structures[Control Structures]
* link:#infix[Infix Methods]
* link:#documentation[Documentation Style]
2.  link:#lang[Language Features]
* link:#override_modifier[override Modifier]
* link:#destruct_bind[Destructuring Binds]
* link:#symbolic_methods[Symbolic Methods (Operator Overloading)]
* link:#type_inference[Type Inference]
* link:#return[Return Statements]
* link:#recursion[Recursion and Tail Recursion]
* link:#exception[Exception Handling]
* link:#option[Options]
* link:#chaining[Monadic Chaining]
* link:#concurrency[Concurrency]
* link:#concurrency-private-this[Private Fields]
* link:#java-default-param-values[Default Parameter Values]
