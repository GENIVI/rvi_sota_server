...
### <a name="wl-1">[WL-1](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-1) Web Server sends index.html page to Web Browser</a>
...
### <a name="wl-2">[WL-2](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-2) Web Server sends Javascript scripts linked in index.html to Web Browser</a>
...
### <a name="wl-3">[WL-3](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-3) Web Server sends CSS Stylesheet files linked in index.html to Web Browser</a>
...
### <a name="wl-4">[WL-4](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-4) Web Browser sends new VIN to Web Server</a>
...
### <a name="wl-5">[WL-5](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-5) Web Server sends new package data to SOTA Core</a>
...
### <a name="wl-6">[WL-6](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-6) Web Server sends new VIN to SOTA Core</a>
...
### <a name="wl-7">[WL-7](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-7) Web Server sends new package data to External Resolver</a>
...
### <a name="wl-8">[WL-8](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-8) Web Server sends new vins to External Resolver</a>
...
### <a name="wl-9">[WL-9](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-9) Web Browser sends new campaign data to Web Server</a>
...
### <a name="wl-10">[WL-10](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-10) Web Server sends new campaign data to SOTA Core</a>
...
### <a name="wl-11">[WL-11](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-11) External Resolver persists new VIN to External Resolver Database</a>
...
### <a name="wl-12">[WL-12](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-12) External Resolver persists new package data to External Resolver Database</a>
...
### <a name="wl-13">[WL-13](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-13) Core persists new VIN to SOTA Core Database</a>
...
### <a name="wl-14">[WL-14](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-14) SOTA Core persists new package data to SOTA Core Database</a>
...
### <a name="wl-15">[WL-15](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-15) Web Browser sends new filter data to Web Server</a>
...
### <a name="wl-16">[WL-16](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-16) Web Server sends new filter data to External Resolver</a>
...
### <a name="wl-18">[WL-18](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-18) Web Browser sends filter-to-package associate to Web Server</a>
...
### <a name="wl-19">[WL-19](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-19) Web Server sends filter-to-package association to External Resolver</a>
...
### <a name="wl-20">[WL-20](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-20) External Resolver persists filter-to-package association to External Resolver Database</a>
...
### <a name="wl-21">[WL-21](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-21) Web Browser sends Queue Package Require to Web Server</a>
...
### <a name="wl-22">[WL-22](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-22) Web Server sends Queue Package Request to Core</a>
...
### <a name="wl-23">[WL-23](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-23) Core looks-up Package ID in Core Database</a>
...
### <a name="wl-24">[WL-24](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-24) Core sends Resolve VIN Request to External Resolver</a>
...
### <a name="wl-25">[WL-25](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-25) External Resolver looks-up Package ID filters in External Resolver Database</a>
...
### <a name="wl-26">[WL-26](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-26) External Resolver looks-up VIN in External Resolver Database</a>
...
### <a name="wl-27">[WL-27](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-27) External Resolver looks-up Package Dependencies in External Resolver Database</a>
...
### <a name="wl-28">[WL-28](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-28) Core sends Software Update Metadata for VIN to RVI Node</a>
...
### <a name="wl-29">[WL-29](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-29) SOTA Core sends "Start Update Available" notification to RVI Node Server</a>
...
### <a name="wl-30">[WL-30](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-30) RVI Node Server sends "Software Update Available" notification to RVI Node Client</a>
...
### <a name="wl-31">[WL-31](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-31) RVI Node Client sends "Software Update Available" notification to SOTA Client</a>
...
### <a name="wl-32">[WL-32](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-32) SOTA Client sends "Software Update Available" notification to Software Loading Manager</a>
...
### <a name="wl-33">[WL-33](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-33) Software Loading Manager sends "Initiate Software Download" notification to SOTA Client</a>
...
### <a name="wl-34">[WL-34](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-34) SOTA Client sends "Initiate Software Download" notification to RVI Node Client</a>
...
### <a name="wl-35">[WL-35](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-35) RVI Node Client sends "Initiate Software Download" notification to RVI Node Server</a>

### <a name="wl-36">[WL-36](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-36) RVI Node Server sends "Initiate Software Download" notification to SOTA Core</a>
...
### <a name="wl-37">[WL-37](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-37) SOTA Core sends "Start Download" notification to RVI Node Server</a>
...
### <a name="wl-38">[WL-38](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-38) RVI Node Server sends "Start Download" notification to RVI Node Client</a>

RVI Node Server can send a "Start Download" notification to RVI Node Client.

### <a name="wl-39">[WL-39](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-39) RVI Node Client sends "Start Download" notification to SOTA Client</a>
...
### <a name="wl-40">[WL-40](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-40) SOTA Client sends "Start Download" notification to Software Loading Manager</a>
...
### <a name="wl-41">[WL-41](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-41) SOTA Core sends lowest numbered data block to RVI Node Server</a>
...
### <a name="wl-42">[WL-42](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-42) RVI Node Server sends lowest numbered data block to RVI Node Client</a>

RVI Node Server can send the lowest numbered data block to RVI Node Client.

### <a name="wl-43">[WL-43](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-43) RVI Node Client sends lowest numbered data block to SOTA Client</a>
...
### <a name="wl-44">[WL-44](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-44) SOTA Client sends lowest numbered data block to Software Loading Manager</a>
...
### <a name="wl-45">[WL-45](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-45) SOTA Core sends "Finalise Download" notification to RVI Node Server</a>
...
### <a name="wl-46">[WL-46](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-46) RVI Node Server sends "Finalise Download" notification to RVI Node Client</a>

RVI Node Server can send a "Finalize Download" notification to RVI Node Client.

### <a name="wl-47">[WL-47](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-47) RVI Node Client sends "Finalise Download" notification to SOTA Client</a>
...
### <a name="wl-48">[WL-48](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-48) Software Loading Manager sends Install Report to SOTA Client</a>
...
### <a name="wl-49">[WL-49](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-49) SOTA Client sends Install Report to RVI Node Client</a>
...
### <a name="wl-50">[WL-50](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-50) SOTA Client sends Install Report to RVI Node Client</a>

RVI Node Client can send an Install Report to the RVI Node Server.

### <a name="wl-51">[WL-51](https://github.com/advancedtelematic/sota-server/wiki/Whitelisted-Interactions#wl-51) RVI Node Server sends Install Report to SOTA Core</a>
